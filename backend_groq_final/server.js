...
app.get('/api/health', (req, res) => {
  ...
  const aiPrimary    = hasDeepSeek ? 'deepseek' : hasAnthropic ? 'anthropic' : null;
...
app.listen(PORT, () => {
  ...
  console.log(`   DeepSeek : ${hasDeepSeek  ? '✅ Configured (primary)' : '⚠️  Not set'}`);
  console.log(`   Anthropic: ${hasAnthropic ? '✅ Configured (fallback)' : '—  Not set'}`);
  console.log('══════════════════════════════════════════════════\n');
});
